        ...
        <div class="container mt-4">
            <form method="post" action="{{url('/users/update')}}">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            <input value="{{$user->department}}" type="text" class="form-control" name="department" placeholder="Department" required>
                        </div>
                    </div>
                    <div class="col alignBox">
                        <div class="mb-3">
                    ...
                    <div class="col">
                        <input value="{{$user->ph_no}}" type="number" class="form-control" name="ph_no" placeholder="ph_no" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col alignBox">
                    ...
                    <div class="col ">
                        <div class="mb-3">
                            <input value="{{$user->doj}}" type="date" class="form-control" name="doj" placeholder="doj" required>
                        </div>
                    </div>
                    <div class="col alignBox">
                        <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <button type="Update" class="btn btn-primary">Update user</button>
                    </div>
                </div>
            </form>
        </div>
